...
export const menus: MenuSeedData[] = [
  ...
  // ==================== 数据字典 Dict [MENU] ====================
  {
    ...
    component: '/src/views/system/dict/index.vue',
    layout: 'normal',
    keepAlive: true,
    method: null,
    description: null,
  ...
  // ==================== 待办 Todo [MENU] ====================
  {
    ...
    component: '/src/views/todo/index.vue',
    layout: 'normal',
    keepAlive: true,
    method: null,
    description: null,
  ...
  // ==================== 前端监控 Metrics [MENU] ====================
  {
    ...
    name: '前端监控',
    code: 'Metrics',
    permission: 'system:metrics:list',
    type: 'MENU',
    pid: 2,
    path: '/monitor',
    redirect: null,
    icon: 'material-symbols:monitor-heart-outline',
    component: '/src/views/monitor/index.vue',
    layout: 'normal',
    keepAlive: true,
    method: null,
    description: null,
  ...
  // ==================== 在线用户 Session [MENU] ====================
  {
    ...
    component: '/src/views/system/session/index.vue',
    layout: 'normal',
    keepAlive: true,
    method: null,
    description: null,
